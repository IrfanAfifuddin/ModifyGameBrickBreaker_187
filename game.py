...
class Ball(GameObject):
    def __init__(self, canvas, x, y):
        ...
        self.speed = random.randint(8, 10)  # #command: Kecepatan bola (acak antara 8-10)
...
class Paddle(GameObject):
    def __init__(self, canvas, x, y):
        ...
        self.color = '#ADD8E6'  # #command: Warna paddle
...
class Brick(GameObject):
    COLORS = {1: '#C0C0C0', 2: '#808080', 3: '#000000'}  # #command: Warna brick berdasarkan jumlah nyawa
